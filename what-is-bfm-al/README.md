...
{% embed url="https://en.wikipedia.org/wiki/Bellman%E2%80%93Ford\_algorithm" caption="" %}

我们利用 BFM 算法进行交叉套利路径的优化搜索。

{% embed url="https://en.wikipedia.org/wiki/Triangular\_arbitrage" caption="" %}
...
有些问题回答不出来？可以看看这个：---&gt; **\*\*\[**代码_\*\]\(_[https://guhhhhaa.gitbook.io/bfm/ruan-jian-bfm-on-python\)\](https://guhhhhaa.gitbook.io/bfm/ruan-jian-bfm-on-python%29\)\*\*\*
{% endhint %}
